...
import com.intijir.gildedingot.util.RegistryHandler;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    GILDED(GildedIngot.MOD_ID + ":gilded", 16, new int[] {2, 5, 7, 2}, 26,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.5F, () -> Ingredient.fromItems(RegistryHandler.GILDED_INGOT.get()), 0.1f);
