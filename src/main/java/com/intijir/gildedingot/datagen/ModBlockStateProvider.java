...
public class ModBlockStateProvider extends BlockStateProvider {
    public ModBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, GildedIngot.MOD_ID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        //blockWithItem(ModBlocks.GILDED_PILE);
        //blockWithItem(ModBlocks.BASALT_LAPIS);
        blockWithItem(ModBlocks.GILDED_GLASS);
        blockWithItem(ModBlocks.GILDED_GLOWSHROOM);
        //blockWithItem(ModBlocks.WARPED_SOUL_SOIL);
        //blockWithItem(ModBlocks.WARPED_NETHER_WART_CROP);
