...
public class ModBlocks {
    public static final Block GILDED_BLOCK = registerBlock("gilded_block",
            new Block(FabricBlockSettings.create().mapColor(MapColor.IRON_GRAY).strength(10, 15000000)
            .requiresTool().sounds(BlockSoundGroup.METAL)));

    public static final Block GILDED_BRICKS = registerBlock("gilded_bricks",
            new Block(FabricBlockSettings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(3, 30000000)
    ...
    public static final Block BLUE_NETHER_BRICKS = registerBlock("blue_nether_bricks",
            new Block(FabricBlockSettings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(10, 10)
            .requiresTool().sounds(BlockSoundGroup.NETHER_BRICKS)));

    public static final Block SMOOTH_BLACKSTONE = registerBlock("smooth_blackstone",
            new Block(FabricBlockSettings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(2, 7)
    ...
    public static final Block BASALT_LAPIS = registerBlock("basalt_lapis",
            new Block(FabricBlockSettings.create().mapColor(MapColor.STONE_GRAY).strength(1.25F, 4.2F)
                    .requiresTool().sounds(BlockSoundGroup.BASALT)));

    public static final Block GILDED_GLASS = registerBlock("gilded_glass",
            new Block(FabricBlockSettings.create().strength(0.3F, 0.3F).nonOpaque().blockVision(Blocks::never).allowsSpawning(Blocks::never).solidBlock(Blocks::never)
                    .sounds(BlockSoundGroup.GLASS)));

    public static final Block GILDED_GLOWSHROOM = registerBlock("gilded_glowshroom",
            new Block(FabricBlockSettings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(1)
                    .requiresTool().sounds(BlockSoundGroup.SHROOMLIGHT).lightLevel(state -> {return 15;})));
    ...
    private static Block registerBlockWithoutBlockItem(String name, Block block) {
        return Registry.register(Registries.BLOCK, new Identifier(GildedIngot.MOD_ID, name), block);
    }
    ...
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(GildedIngot.MOD_ID, name),
