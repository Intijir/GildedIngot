...
public class ModItems {
    ...
    // Tools
    public static final DeferredItem<Item> GILDED_SWORD = ITEMS.register("gilded_sword",
            () -> new SwordItem(ModTiers.GILDED, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModTiers.GILDED, 4, -2.4f))));

    public static final DeferredItem<Item> GILDED_PICKAXE = ITEMS.register("gilded_pickaxe",
            () -> new PickaxeItem(ModTiers.GILDED, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModTiers.GILDED, 1, -2.8f))));

    public static final DeferredItem<Item> GILDED_AXE = ITEMS.register("gilded_axe",
            () -> new AxeItem(ModTiers.GILDED, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModTiers.GILDED, 6, -3.1f))));

    public static final DeferredItem<Item> GILDED_SHOVEL = ITEMS.register("gilded_shovel",
            () -> new ShovelItem(ModTiers.GILDED, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModTiers.GILDED, 2, -3.0f))));

    public static final DeferredItem<Item> GILDED_HOE = ITEMS.register("gilded_hoe",
            () -> new HoeItem(ModTiers.GILDED, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModTiers.GILDED, 0, -1.0f))));


    // Armor
    public static final DeferredItem<Item> GILDED_HELMET = ITEMS.register("gilded_helmet",
            () -> new ArmorItem(ModArmorMaterials.GILDED, ArmorItem.Type.HELMET, (new Item.Properties())));

    public static final DeferredItem<Item> GILDED_CHESTPLATE = ITEMS.register("gilded_chestplate",
            () -> new ArmorItem(ModArmorMaterials.GILDED, ArmorItem.Type.CHESTPLATE, (new Item.Properties())));

    public static final DeferredItem<Item> GILDED_LEGGINGS = ITEMS.register("gilded_leggings",
            () -> new ArmorItem(ModArmorMaterials.GILDED, ArmorItem.Type.LEGGINGS, (new Item.Properties())));

    public static final DeferredItem<Item> GILDED_BOOTS = ITEMS.register("gilded_boots",
