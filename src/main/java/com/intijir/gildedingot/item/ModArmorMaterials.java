...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> GILDED = register("gilded",
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(GildedIngot.MOD_ID, name);
